...
RUN_DIR=${EXP_DIR}/runs/bypass_16gpu_ccld/allreduce_kill3
...
mpirun \
  ...
  bash -lc '
    ...
    exec /public/home/scnethpc26107/sdr/ftccl/custom-rccl-dtk-26.04/exp/survivor_collective_ring/bin/survivor_collective_after_kill \
      ...
      --iters 5 \
      --timeout-sec 60 \
      --id-file /public/home/scnethpc26107/sdr/ftccl/custom-rccl-dtk-26.04/exp/survivor_collective_ring/runs/bypass_16gpu_ccld/allreduce_kill3/nccl_unique_id.bin \
      --sync-dir /public/home/scnethpc26107/sdr/ftccl/custom-rccl-dtk-26.04/exp/survivor_collective_ring/runs/bypass_16gpu_ccld/allreduce_kill3/sync \
      --ccld-dump-dir /public/home/scnethpc26107/sdr/ftccl/custom-rccl-dtk-26.04/exp/survivor_collective_ring/runs/bypass_16gpu_ccld/allreduce_kill3/ccld'
