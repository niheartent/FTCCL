...
/* Returns the hip device number associated with the communicator. */
 ...
 * a single NCCL operation. Nothing will be started on the HIP stream until
 * ncclGroupEnd.
 */
 ...
 * ncclGroupStart. Operations on the HIP stream depending on the NCCL operations
